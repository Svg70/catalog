...
export const changeDescriptionCells = (id, year, nominal, number, common, varieties, astimation, addInfo, sourses) =>

    async (dispatch, getStore) => {
        let responce = await TableAPI.changeDescriptionCells(id, year, nominal, number, common, varieties, astimation, addInfo, sourses)
        debugger
