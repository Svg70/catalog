...
import './AdminNumbersAddingForm.css';

const AdminNumbersAddingForm = ({
...
AdminNumbersAddingForm.propTypes = {
...
AdminNumbersAddingForm.defaultProps = {
  title: 'Modal title',
  isOpen: true,
  onCancel: () => { },
  children: null,
...
export default AdminNumbersAddingForm;
